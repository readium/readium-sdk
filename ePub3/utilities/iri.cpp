...
IRI::IRI(const string& scheme, const string& host, const string& path, const string& query, const string& fragment) : _urnComponents(), _url(ePub3::make_unique<GURL>())
{
...
IRI& IRI::operator=(const IRI& o)
{
    ...
    if ( _url != nullptr )
        *_url = *o._url;
        ...
        _url = ePub3::make_unique<GURL>(*o._url);
    return *this;
}
