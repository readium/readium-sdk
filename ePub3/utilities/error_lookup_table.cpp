...
INITIALIZER(__initErrorTables)
{
    ...
    gErrorLookupTable[EPUBError::OCFInvalidRelativeIRI] = ErrorInfo(ViolationSeverity::Medium, EPUBSpec::OpenContainerFormat, "2.3", "Medium. IRIs should all be relative; META-INF contents are relative to root, not self.");
    ...
    gErrorLookupTable[EPUBError::MediaOverlayTextSrcFragmentMissing] = ErrorInfo(ViolationSeverity::Major, EPUBSpec::MediaOverlays, "2.4.7", "A <text> element's 'src' attribute MUST contain a fragment identifier.");
