...
static const ErrorLookup gErrorLookupTable = {
    ...
    {EPUBError::OPFFallbackChainHasNoContendDocument, {ViolationSeverity::Medium, EPUBSpec::OpenPublicationFormat, "5.2.2", "A fallback chain MUST contain a valid EPUB Content Document."}},
    ...
    {EPUBError::CFINonAssertedXMLID, {ViolationSeverity::Medium, EPUBSpec::CanonicalFragmentIdentifiers, "3.1.2", "A CFI step referencing an XML node with an 'id' attribute MUST assert that ID as part of the step."}},
...
INITIALIZER(__initErrorTables)
{
    ...
    gErrorLookupTable[OPFFallbackChainHasNoContendDocument] = ErrorInfo(EPUBError::ViolationSeverity::Medium, EPUBSpec::OpenPublicationFormat, "5.2.2", "A fallback chain MUST contain a valid EPUB Content Document.");
    ...
    gErrorLookupTable[CFINonAssertedXMLID] = ErrorInfo(EPUBError::ViolationSeverity::Medium, EPUBSpec::CanonicalFragmentIdentifiers, "3.1.2", "A CFI step referencing an XML node with an 'id' attribute MUST assert that ID as part of the step.");
