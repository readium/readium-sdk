...
namespace ReadiumPhoneSupport
{
    ...
    public class XmlComment : IXmlComment
    {
        internal XComment _base;

        internal XmlComment(XComment linq)
        {
            _base = linq;
        }
        ...
        {
            if (deep)
                return NodeConversion.ConvertNode(new XComment(_base));
            return NodeConversion.ConvertNode(new XComment(_base.Value));
        }
        ...
        {
            get { return NodeType.CommentNode; }
        }
